...
pcall(function()
    if API then
        Remotes.DataChanged         = getRemoteByName("DataChanged")
        Remotes.DataInit            = getRemoteByName("ReplicateInitData")
        Remotes.DataPartial         = getRemoteByName("DataPartiallyChanged")
        Remotes.PayCollect          = getRemoteByName("Collect")
        Remotes.ClaimDailyReward    = getRemoteByName("ClaimDailyReward")
        Remotes.ClaimStarReward     = getRemoteByName("ClaimStarReward")
        ...
        Remotes.PizzaClaim          = getRemoteByName("PizzaShopClaimDough")
        Remotes.PizzaNav            = getRemoteByName("NavigateToPizzaShopConveyor")
        Remotes.MinigameJoin        = getRemoteByName("AttemptJoin")
        Remotes.MicrogameStart      = getRemoteByName("AttemptStart")
        Remotes.TeleToLocation      = getRemoteByName("TeleToLocation")
        Remotes.PetProgressed       = getRemoteByName("PetProgressed")
        Remotes.PetHatched          = getRemoteByName("PetHatched")
        Remotes.FocusPet            = getRemoteByName("FocusPet")
        Remotes.UnfocusPet          = getRemoteByName("UnfocusPet")
        Remotes.ReplicateReactions  = getRemoteByName("ReplicateActiveReactions")
        Remotes.ResetPetNetwork     = getRemoteByName("ResetNetworkOwnership")
        Remotes.ClaimPetProgression = getRemoteByName("ClaimProgressionReward")
    end
end)
